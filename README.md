...
Maintainer: Sharwan Bagaria

This repository contains my customized and actively maintained version of HealthStack-System.

### Key improvements
- Security improvements (Google Maps API key externalization)
- Environment configuration enhancements
- Additional context processors for template variables
